...
echo "====================================================================="
#sudo kubectl config --kubeconfig=/var/lib/kubelet/bootstrap-kubeconfig set-cluster bootstrap --server='https://192.168.0.30:6443' --certificate-authority=/var/lib/kubernetes/ca.crt
