...
ssh -i ../../.vagrant/machines/master-1/virtualbox/private_key \
    vagrant@192.168.0.11 /bin/bash /vagrant/ubuntu/run/03-client-tools.sh
...
echo "@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@"
ssh -i ../../.vagrant/machines/master-1/virtualbox/private_key vagrant@192.168.0.11 \
...
sleep 3
ssh -i ../../.vagrant/machines/master-2/virtualbox/private_key vagrant@192.168.0.12 \
        /bin/bash /vagrant/ubuntu/run/07-bootstrapping-etcd.sh
...
ssh -i ../../.vagrant/machines/master-2/virtualbox/private_key vagrant@192.168.0.12 \
        /bin/bash /vagrant/ubuntu/run/08.1-bootstrapping-kubernetes-controllers.sh
sleep 3
ssh -i ../../.vagrant/machines/loadbalancer/virtualbox/private_key vagrant@192.168.0.30 \
...
ssh -i ../../.vagrant/machines/worker-1/virtualbox/private_key vagrant@192.168.0.21 \
...
ssh -i ../../.vagrant/machines/worker-2/virtualbox/private_key vagrant@192.168.0.22 \
