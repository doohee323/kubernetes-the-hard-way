...
ssh -i ../../.vagrant/machines/master-1/virtualbox/private_key \
    doohee323@192.168.0.139 /bin/bash /vagrant/ubuntu/run/03-client-tools.sh
...
echo "@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@"
ssh -i ../../.vagrant/machines/master-1/virtualbox/private_key doohee323@192.168.0.139 \
...
sleep 3
ssh -i ../../.vagrant/machines/master-2/virtualbox/private_key doohee323@192.168.0.12 \
        /bin/bash /vagrant/ubuntu/run/07-bootstrapping-etcd.sh
